...
function Skill() {
  return (
    <div id='skills' className='Skill'>
        ...
        <p>From raw materials to finished products, our fabrication capabilities cover a wide range of needs. Explore our services or get an instant quote for your CNC project.
</p>
        <div className='bar2'></div>
        </div>

        <div className='compmain'>
        <h3>Repair & Maintenance Services
        </h3>
        <p>Professional repair and preventive maintenance of electronic machines and equipment. On-site and
        workshop services designed to minimize downtime for clients.</p>
        <div className='bar3'></div>
        </div>

        <div className='software'>
        <h3>Manufacturing of Modern Technology Systems
        </h3>
